...
enum AppTheme {
    ...
    static let cardHighlightedBackground = UIColor.tertiarySystemFill
    static let overlayBackground = UIColor.black.withAlphaComponent(0.46)
    ...
    static func applyGlobalAppearance() {
        ...
        navAppearance.titleTextAttributes = [
            ...
            .font: roundedFont(ofSize: 18, weight: .semibold)
        ]
        ...
        UIBarButtonItem.appearance().setTitleTextAttributes([
            .font: roundedFont(ofSize: 16, weight: .semibold)
        ], for: .normal)
    }
    ...
    static func stylePrimaryButton(_ button: UIButton) {
        ...
        button.titleLabel?.font = roundedFont(ofSize: 18, weight: .semibold)
    ...
    static func styleSecondaryButton(_ button: UIButton) {
        ...
        button.setTitleColor(secondaryText, for: .disabled)
        button.titleLabel?.font = roundedFont(ofSize: 16, weight: .semibold)
        button.layer.cornerRadius = 12
        button.layer.cornerCurve = .continuous
    ...
    static func styleFloatingButton(_ button: UIButton) {
        button.backgroundColor = overlayBackground
        button.setTitleColor(.white, for: .normal)
    ...
    static func styleCard(_ view: UIView) {
        ...
        view.layer.borderColor = UIColor.separator.withAlphaComponent(0.5).cgColor
    }
